...
QT_MOC_LITERAL(1, 11, 9), // "pauseGame"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "changedCell"
QT_MOC_LITERAL(4, 34, 1), // "x"
QT_MOC_LITERAL(5, 36, 1), // "y"
QT_MOC_LITERAL(6, 38, 6), // "status"
QT_MOC_LITERAL(7, 45, 7) // "repaint"

    },
    "RenderArea\0pauseGame\0\0changedCell\0x\0"
    "y\0status\0repaint"
};
...
void RenderArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pauseGame(); break;
        case 1: _t->changedCell((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenderArea::pauseGame)) {
                *result = 0;
            }
        }
        {
            typedef void (RenderArea::*_t)(int , int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenderArea::changedCell)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void RenderArea::pauseGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void RenderArea::changedCell(int _t1, int _t2, bool _t3)
{
